...
async def get_pull_request(owner: str, repo: str, pr_number: int, org_id: str):
...
async def summarize_pull_request(owner: str, repo: str, pr_number: int, org_id: str):
    summary = await service.summarize_pull_request(org_id, f"{owner}/{repo}", pr_number)
    return {"summary": summary}


@router.post("/{owner}/{repo}/{pr_number}/approve")
async def approve_pull_request(owner: str, repo: str, pr_number: int, org_id: str, payload: PRActionRequest):
...
async def request_changes(owner: str, repo: str, pr_number: int, org_id: str, payload: PRActionRequest):
...
async def comment_on_pull_request(owner: str, repo: str, pr_number: int, org_id: str, payload: PRActionRequest):
...
async def merge_pull_request(owner: str, repo: str, pr_number: int, org_id: str, payload: PRMergeRequest):
...
async def close_pull_request(owner: str, repo: str, pr_number: int, org_id: str):
