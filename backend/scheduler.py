...
def start_scheduler():
    ...
    # (never deletes, never scrapes); cheap enough to run once a day.
    scheduler.add_job(run_stale_job_cleanup, "cron", hour=3, minute=0, timezone="Asia/Kolkata", id="job_hunter_stale_cleanup_job")
    scheduler.start()
